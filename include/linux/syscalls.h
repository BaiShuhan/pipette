...
asmlinkage long sys_slabs_setting_init(size_t maxbytes, int factor, int chunk_size,
		                int slab_chunk_size_max, int slab_page_size,
				const uint32_t *slab_sizes);
asmlinkage long sys_slabs_exit(int wanna_reset, int, refcntThreshold, int, SetMinThreshold, int, SetMaxThreshold, int, SetResetCnt);
#endif
